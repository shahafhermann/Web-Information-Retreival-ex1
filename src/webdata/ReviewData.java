...
public class ReviewData implements Serializable {
    ...
    public String getReviewScore(int i) { return reviewScore[i]; }

    public String getReviewHelpfulness(int i) { return reviewHelpfulness[i]; }

    public String getProductId(int i) { return productId[i]; }

    public String getTokensPerReview(int i) { return tokensPerReview[i]; }
